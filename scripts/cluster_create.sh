...
kubectl create -n $tenant -f $working_dir/k8s/jmeter_slaves_deploy.yaml

kubectl create -n $tenant -f $working_dir/k8s/jmeter_slaves_svc.yaml

echo "Creating Jmeter Master"

kubectl create -n $tenant -f $working_dir/k8s/jmeter_master_configmap.yaml

kubectl create -n $tenant -f $working_dir/k8s/jmeter_master_deploy.yaml


echo "Creating Influxdb and the service"

kubectl create -n $tenant -f $working_dir/k8s/jmeter_influxdb_configmap.yaml

kubectl create -n $tenant -f $working_dir/k8s/jmeter_influxdb_deploy.yaml

kubectl create -n $tenant -f $working_dir/k8s/jmeter_influxdb_svc.yaml

echo "Creating Grafana Deployment"

kubectl create -n $tenant -f $working_dir/k8s/jmeter_grafana_deploy.yaml

kubectl create -n $tenant -f $working_dir/k8s/jmeter_grafana_svc.yaml
